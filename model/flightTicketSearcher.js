...
FlightTicketSearcher.prototype = {
  ...
  _validateCity: function(errors, city, fieldName) {
    ...
    else if(!_(this._validCities).contains(city)) errors.push({field: fieldName, message: 'Somente capitais da região Sul e Sudeste do Brasil são atendidas pela companhia aérea.'});
    return errors;
  },
